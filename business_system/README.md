# UrbanFlow Business System

Sistema completo para la gestión de negocios no alimenticios (tiendas, farmacias, etc.) con almacenamiento local y respaldo en la nube.

## 📁 Estructura de Carpetas

```
C:\UrbanFlow\[NombreNegocio]\
├── config/
│   ├── negocio.json             # Datos generales del negocio
│   ├── roles.json               # Roles personalizados
│   ├── zonas.json               # Zonas de delivery
│   ├── plantilla.json           # Template visual de la tienda
...
- Configuración específica por rubro (ej: farmacia)

### 2. Sistema de Roles Personalizables
- Roles predefinidos: Dueño, Encargado, Cajero, Farmacéutico, Delivery, Vendedor
- Permisos granulares por sección
- Personalización completa de roles
- Soporte para profesionales con matrícula
...
- Información de peso para envíos
- Control de recetas (para farmacias)
...
- Información profesional (matrícula, profesión)
...
- Los datos se guardan localmente en la PC del negocio
- No se envían fotos a la nube (solo texto)
- Cada empleado tiene su propio PIN
- Logs de auditoría completos
- Control de permisos por rol
- Control de productos controlados (farmacias)

## 🚀 Instalación

1. Crear carpeta: `C:\UrbanFlow\[NombreNegocio]\`
2. Copiar estructura de archivos JSON
3. Configurar datos del negocio en `config/negocio.json`
...
- [ ] Sistema de recetas electrónicas (farmacias)
- [ ] Control de productos controlados
- [ ] Reportes avanzados
